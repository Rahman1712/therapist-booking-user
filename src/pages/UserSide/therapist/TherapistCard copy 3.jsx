...
const TherapistCard = ({ therapist }) => {
  ...
  return (
    ...
    <div className="mb-5 mb-md-0 flex items-stretch">
      ...
      bg-gradient-to-r from-teal-50 to-lime-50 hover:bg-gradient-to-l hover:from-teal-50 hover:to-lime-50 focus:ring-4 focus:outline-none focus:ring-lime-50 dark:focus:ring-teal-700
      ">
        <div className="h-[100px] rounded-tl-md rounded-tr-md 
        bg-gradient-to-r from-indigo-100 via-cyan-50 to-indigo-100 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-100 dark:focus:ring-blue-400
        "></div>
