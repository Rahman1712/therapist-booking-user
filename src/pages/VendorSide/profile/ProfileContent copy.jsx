                  ...
                  <div className="lg:col-span-1">
                    <div className="bg-white shadow border rounded p-4">
                      ...
                      <p>
                        ...
                        <span
                          className={`badge fw-bolder ${therapist.enabled ? 'text-success' : 'text-danger'
                            }`}
                        >
                          {therapist.enabled}
                        </span>
                      ...
                      <p>
                        Activated:{' '}
                        <span
                          className={`badge fw-bolder ${therapist.activated ? 'text-success' : 'text-danger'
                            }`}
                        >
                          {therapist.activated}
                        </span>
                      ...
                      <p>
                        Details Submitted:{' '}
                        <span
                          className={`badge fw-bolder ${therapist.submitted ? 'text-success' : 'text-danger'
                            }`}
                        >
                          {therapist.submitted}
                        </span>
