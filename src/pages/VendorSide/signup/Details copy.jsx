        ...
        <div className="flex flex-col md:flex-row md:p-6 md:pt-2">
          <div className="md:w-1/3 p-12 mt-5 rounded-lg">
            <div className="w-full shadow-lg rounded-lg ">
              <div className="p-5 border rounded-lg min-h-[400px]">
                <form onSubmit={handleImageSubmit} >
                  <div className="mb-4 ">
                    ...
                    <div className="flex justify-center relative mt-5">
                      ...
                      <BiEdit className="absolute right-5 font-bold text-gray-600 cursor-pointer text-[20px]" onClick={openImageUpload} />
                    </div>
                    <input
                      type="file"
                      // accept="image/*"  // all types
                      accept="image/jpeg, image/png" // png and jpeg
                      id="profileImage"
                      name="profileImage"
                      ref={profileImageRef}
