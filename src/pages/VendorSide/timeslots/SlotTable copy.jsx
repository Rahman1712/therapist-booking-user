                              ...
                              <li className="pb-3 sm:pb-4" key={i}>
                                <div className="flex items-center space-x-4">
                                  <div className="flex-1 min-w-0">
                                    ...
                                    <p className={`text-sm text-gray-500 truncate dark:text-gray-400 ${time_slot.booked ? 'text-green-400' : 'text-rose-400'}`}>
                                      {time_slot.booked ? 'booked' : 'not booked'}
                                    </p>
                                  </div>
                                  {!time_slot.booked && <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white cursor-pointer ">
